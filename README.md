...
- If you don't want to modify the existing package.xml file & only want to generated xml content, click on **Copy to Clipboard** button. This copies the formatted package.xml contents to clipboard to be pasted somewhere else.
